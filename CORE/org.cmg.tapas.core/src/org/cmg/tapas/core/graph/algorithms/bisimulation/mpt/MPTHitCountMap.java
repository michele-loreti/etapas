...
/** 
 * MPTHitCountMap rappresenta una mappa per tenere traccia 
 ...
 **/
class MPTHitCountMap<S,A extends ActionInterface> {
	/** La mappa. **/
	private HashMap<MPTSplitter<S>, HashMap<A, HashMap<S, Integer>>> map =
		new HashMap<MPTSplitter<S>, HashMap<A, HashMap<S, Integer>>>();
	 ...
	 **/
	public void removeCounts(MPTSplitter<S> splitter) {
		map.remove(splitter);
	}
